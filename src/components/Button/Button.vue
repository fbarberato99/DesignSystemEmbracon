...
.btn {
  ...
  font-weight: var(--typography-text-body-bold-weight);
...
.btn--primary:active:not(:disabled):not(.btn--loading) {
  background-color: var(--colors-primary-red-dark);
}
...
.btn--secondary:active:not(:disabled):not(.btn--loading) {
  border-color: var(--colors-primary-red-dark);
  color: var(--colors-primary-red-dark);
}
